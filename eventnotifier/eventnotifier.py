...
class EventNotifier(commands.Cog):
    def __init__(self, bot: Red):
        ...
        # Add to existing emoji definitions
        self.YES_EMOJI = "✅"
        self.NO_EMOJI = "❌"
        self.MAYBE_EMOJI = "❔"
    ...
    # Add new commands for reminder configuration
    @event.command()
    @commands.mod()
    async def setreminders(self, ctx, *minutes: int):
        ...
        # Sort reminders in descending order
    ...
    # Modify the reaction handler to assign roles
    ...
    # Modified check_events to handle reminders
