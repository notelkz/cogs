...
class AppTest(commands.Cog):
    ...
    async def sendembed(self, ctx, channel_id: int):
        ...
        # If you want the thumbnail to work, attach the file:
        # file = discord.File("path/to/zerosmall.png", filename="zerosmall.png")
        # await channel.send(content=hashtag, embed=embed, view=PublicApplicationView(self, ctx.guild), file=file)
        # Otherwise, just send without the thumbnail:
...
# --- NEW: Public Application View for sendembed command ---
