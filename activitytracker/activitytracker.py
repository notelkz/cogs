...
class ActivityTracker(commands.Cog):
    ...
    async def _check_for_promotion(self, guild, member, total_minutes):
        ...
        # Sort ranks by required_hours ascending for consistent next_rank logic
        ...
        for rank_data in sorted_ranks_ascending: # Iterate ascending to find highest *eligible*
